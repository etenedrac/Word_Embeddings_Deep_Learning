...
###               CHANGES               ###
###########################################
EXPERIMENT_DIRECTORY = "./train_log/Experiment_1"
...
EMBEDDING_DIM = 384 #Dimension of the embedding vector
CONTEXT_WINDOW = 1 #Words to consider left and right.
...
def word2vec_basic(log_dir):
  ...
  vocabulary = tf.compat.as_str(" ".join(sentences)).split()
  print(vocabulary[:10])
  ...
  skip_window = CONTEXT_WINDOW  # How many words to consider left and right.
  ...
  with tf.Session(graph=graph) as session:
    ...
    with codecs.open(log_dir + '/metadata.tsv', 'w', "utf-8") as f:
