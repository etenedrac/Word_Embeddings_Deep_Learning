	...
	while True:
		...
		for sentence in sentences:
			...
			for i in range(sentence_length):
				...
				#print("Shapes: ",[current_word_index.shape, context_word_indexes.shape, negative_samples.shape], [np.array([1.0]).shape, np.zeros((1,G.negative)).shape])
				#print("First output: ",[current_word_index, context_word_indexes, negative_samples], [np.array([1.0]), np.zeros((1,G.negative))])
